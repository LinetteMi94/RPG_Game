        ...
        spirit:23)
{
    ...
    protected internal override string ClassName => "Астромант";
    ...
    public override List<Spell> LearnedSpells { get; set; } 
        = [new("Бить голыми руками")
            ...
            new("Астральный импульс")
            {
                    ...
                    Sound = new SpellSound("Sounds/Spells/Astromancer/Astral_Impulse_Impact.mp3", "Sounds/Spells/Astromancer/Astral_Impulse_Cast.mp3")
            },
            new ("Падающая звезда")
                {
                    NeedResource = 30,
                    ...
                    Sound = new SpellSound("Sounds/Spells/Astromancer/Falling_Star_Impact.mp3", "Sounds/Spells/Astromancer/Falling_Star_Cast.mp3")
                }];
        ...
        = [new("Разрыв пространства")
                {
                    ...
                    Sound = new SpellSound("Sounds/Spells/Astromancer/Space_Rift_Impact.mp3", "Sounds/Spells/Astromancer/Space_Rift_Cast.mp3")
                }];
}