            ...
            new("Ледяная стрела")
                {
                    ...
                    Sound = new SpellSound("Sounds/Spells/Mage/Ice_Arrow_Impact.mp3", "Sounds/Spells/Mage/Ice_Arrow_Cast.mp3")
                }
            , new ("Огненный шар")
                {
                    NeedResource = 20,
                    ...
                    Sound = new SpellSound("Sounds/Spells/Mage/Fireball_Impact.mp3", "Sounds/Spells/Mage/Fireball_Cast.mp3")
                }];
        ...
        = [new("Электрический разряд")
                {
                    ...
                    Sound = new SpellSound("Sounds/Spells/Mage/Electric_Discharge_Impact.mp3", "Sounds/Spells/Mage/Electric_Discharge_Cast.mp3")
                }];
}