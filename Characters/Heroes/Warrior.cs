        ...
        = [new("Бить голыми руками")
            {
                ...
                Messages = new()
                {
                    DamageMessages =
                    {
                        "👊 Воин атакует врага кулаком!",
                        "💥 Воин наносит противнику мощный удар!",
                        "🥊 Воин бросается в рукопашную атаку!"
                    },
                    MissMessages =
                    {
                        "👊 Воин замахивается, но удар проходит мимо!",
                        "💨 Воин пытается ударить врага, но тот уклоняется!",
                        "🥊 Воин промахивается и едва не теряет равновесие!"
                    }
                },
